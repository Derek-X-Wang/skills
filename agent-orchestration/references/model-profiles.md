...
The evidence comes from Derek's project work and explicit operating judgments through 2026-09-06, not a formal benchmark. Keep only material per-model differences below.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| OpenAI | GPT-5.6 Sol | `gpt-5.6-sol` (current local model ID; verify the resolved model at dispatch) | Codex; high or higher effort | Slightly stronger overall than Opus in Derek's use; strong implementation and self-correction; strong fresh reviewer | Still requires independent review when R1 or R2 applies. Derek observes overscoping and excess persistence (2026-09-05): bind scope and stop rules in every dispatch and do not delegate open-ended authority | Proven implementation fallback at high effort; strong eligible reviewer under tight scope and stop rules, not the default primary reviewer of important Astra work | Repeated implementation and review; overscoping observed by Derek, 2026-09-05; high confidence |
| OpenAI | GPT-6 Astra | `gpt-6-astra` (verify the resolved model at dispatch) | Codex; medium for normal workers selected 2026-09-06; xhigh retained for takeover and bounded repo audit, and available for additional important review | Roughly Fable-level strength in Derek's judgment; strong computer use; strong scope and boundary judgment; coding quality close to Fable | No local benchmark proves medium superior to Sol high or measures savings; no verified pricing | Default Codex implementation worker at medium; eligible for routine Codex research. Orchestrator and judge; preferred new-orchestration alternative when Fable capacity runs out. Xhigh takeover worker, sole bounded `audit-repo` auditor, and fresh reviewer subject to [review-policy.md](review-policy.md); never displaces a healthy active orchestrator | Derek's operating judgment, 2026-09-05, medium confidence; medium default is a user preference dated 2026-09-06, not measured superiority |
